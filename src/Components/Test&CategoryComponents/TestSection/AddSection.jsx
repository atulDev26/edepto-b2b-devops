...
const AddSection = ({ callback, categoryIdPlusSubCategoryId }) => {
    ...
    async function addTestSection() {
        ...
        let resp = await postApi(urlApi.addTestSection + categoryIdPlusSubCategoryId, postData)
