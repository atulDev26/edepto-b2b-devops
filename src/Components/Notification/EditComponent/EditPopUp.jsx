...
const EditPopUp = ({ callback, callbackTwo, data }) => {
    ...
    return (
        <>
            ...
            <div className='mt-2'>
                ...
                {<img src={!fileDetails ? data?.popup?.imageUrl ?? "null" : URL.createObjectURL(fileDetails)} alt="" className='w-[100%] h-[211px] object-cover rounded-3xl mt-3' />}
                <div className='border p-2 rounded-xl mt-3 mb-2'>
                    <label className='font-semibold text-sm'>Upload Image &nbsp;</label>
                    <input
                        type="file"
