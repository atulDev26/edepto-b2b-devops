...
const ImportTeachersModal = ({ callback }) => {
    ...
    async function importTeachers() {
        ...
        loadingShow();
        let resp = await imageUploadApi(urlApi.importAllTeacher, formData);
        loadingHide();
            ...
            >
                <Modal.Header>
                    <div className="w-full flex justify-between items-center">
                        <p className="font-semibold text-base cursor-default">
                            Import Teacher<span className='text-red-700 font-semibold text-xs'>(Warning do not change headers)</span>
                        </p>
                        <div>
                            <img
                ...
                <Modal.Body>
                    <div className='p-3'>
                        ...
                        <Link className='p-2 bg-primary-blue text-white-color rounded-md' target='_blank' to={process.env.PUBLIC_URL + "/Assets/FileCSV/Teacher_List_Demo.csv"} download>Download DEMO Sheet</Link>
